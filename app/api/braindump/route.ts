...
# 할 일
- 흩어진 입력 속에서 '실행 가능한 오늘의 할 일 후보'를 최대 10개까지 골라내세요. 억지로 10개를 채우지 마세요 — 실제로 보이는 만큼만요. 1개여도 괜찮아요.
- 이것은 확정이 아니라 '후보 제시'예요. 무엇을 오늘 할지는 사용자가 직접 고릅니다. 그러니 고르라고 재촉하는 말은 하지 마세요.
...
function braindumpUser(braindump: string): string {
  return `[브레인덤프]\n${braindump}\n\n위 내용에서 실행 가능한 오늘의 할 일 후보를 최대 10개까지 뽑아 주세요. 후보를 만들기 어려운 입력이면 구체적인 예시 2~3개로 다시 쏟아내도록 도와주세요.`;
}
