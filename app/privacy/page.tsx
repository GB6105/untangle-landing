 ...
 * lib/llm.ts, 기기 저장은 components/demo/state.ts를 근거로 적었다. 그쪽 동작이
 * 바뀌면 이 문서도 함께 고쳐야 한다.
 */
...
const SECTIONS: Section[] = [
  {
    title: "1. 받는 정보",
    paragraphs: [
      "체험을 마친 뒤 남기는 소감 폼에서만 정보를 받습니다. 랜딩을 둘러보거나 데모를 체험하는 것만으로는 아무것도 받지 않습니다.",
    ],
    bullets: [
      "필수 — 체험 만족도 점수(1~5)",
      "선택 — 아쉬웠던 이유, 자유롭게 적어주신 의견",
      "선택 — 사전 신청 연락처(이메일 또는 휴대폰 번호)",
    ],
    footnote:
      "쿠키나 광고 식별자, 방문 기록을 따라다니는 분석 도구는 쓰지 않습니다. 다만 사이트가 올라가 있는 호스팅 사업자가 자체적으로 남기는 접속 기록까지 저희가 통제하지는 못합니다.",
  },
  {
    title: "2. 쓰는 곳",
    bullets: [
    ...
    footnote: "위 두 가지 밖의 일에는 쓰지 않습니다.",
  },
  {
    title: "3. 얼마나 두는지, 어떻게 지우는지",
    bullets: [
      "사전 신청 연락처 — 정식 출시 안내를 보낸 뒤 곧바로 지웁니다.",
  ...
  },
  {
    ...
    footnote:
      "브라우저에서 사이트 데이터를 지우거나, 데모 마지막 화면의 “처음부터 다시 해보기”를 누르면 삭제됩니다.",
  },
];
