...
const SECTIONS: Section[] = [
  {
    ...
    bullets: [
      ...
      "익명 이용 기록 — 어떤 화면을 봤는지, 데모의 어느 단계까지 진행했는지, 어떤 버튼을 눌렀는지 같은 행동의 흔적(누른 시각, 머문 시간, 글자 수·항목 개수 같은 숫자만)",
    ],
    footnote:
      "이용 기록은 누가 남겼는지 특정하지 않는 익명 정보이며, 서비스 개선을 위한 집계에만 씁니다. 광고 식별자나 쿠키는 쓰지 않고, 방문을 이어보기 위해 브라우저에 익명 식별자 하나만 저장합니다. 무엇보다 데모에 쏟아내신 문장이나 할 일 제목처럼 ‘적으신 내용 자체’는 이 기록에 담지 않습니다. 이 처리는 아래 4항의 PostHog에 맡깁니다.",
  },
  {
    title: "2. 쓰는 곳",
    bullets: [
